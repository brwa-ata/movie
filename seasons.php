        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                $query = "SELECT season_of_tvshow.id ,  season_of_tvshow.image,  season_of_tvshow.overview,  season_of_tvshow.year,  season_of_tvshow.season  
                                from season_of_tvshow  INNER JOIN tv_shows ON season_of_tvshow.tv_shows_id=tv_shows.id  WHERE tv_shows.id=$the_tvshow_id";
                ...
                while ($row = mysqli_fetch_assoc($get_season)) {
                    ...
                    <a href="episodes.php?season_id=<?php echo $season_id; ?>&tvshow_id=<?php echo $the_tvshow_id ?>"><img
                                class="img-responsive" src="images/GOTH/<?php echo $season_image; ?> "></a>

                    <h3>Overview </h3>
                    <?php echo $season_overview; ?>
                    <hr>
                    <?php
                }
                }
