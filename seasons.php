...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <?php
                    $query="SELECT season_of_tvshow.image,  season_of_tvshow.overview,  season_of_tvshow.year,  season_of_tvshow.season  
                ...
                <h3><?php echo $season_number; ?> <?php echo '('.$season_year.')'; ?></h3>
                        <a href=""><img class="img-responsive" src="images/GOTH/<?php echo $season_image; ?> "></a>
