        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <?php
                    ...
                    $query2="SELECT  id,released_date FROM films WHERE released_date =now() OR released_date=DATE_ADD(now(), INTERVAL 10 DAY) ";
                ...
                <?php // SHOW ALL FILMS
                    $query="SELECT id,video_title, date_format(released_date,'%Y') as 'released_date' , image FROM films 
                           WHERE released_date =now() OR released_date=DATE_ADD(now(), INTERVAL 10 DAY)  LIMIT $page_1,$pager ";
