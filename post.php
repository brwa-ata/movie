    ...
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            while ($row = mysqli_fetch_assoc($show_film)) {
                ...
                <?php  include "includes/watch_and_fav.php"?>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            ?>
                        ...
                        <a  class="btn btn-primary" href="seasons@<?php echo $the_tvshow_id; ?>">View all season <span class="glyphicon glyphicon-chevron-right"></span></a>
            <?php
                    }
                }
            ?>
